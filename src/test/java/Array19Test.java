...
public class Array19Test {
    ...
    public void Test_sortSpiralMatrix(){
        ...
        assertArrayEquals(new Array19().sortSpiralMatrix(0,5,new int[][]{}),new int[][]{});
        assertArrayEquals(new Array19().sortSpiralMatrix(3,0,new int[][]{}),new int[][]{{},{},{}});
        assertArrayEquals(new Array19().sortSpiralMatrix(1,5,new int[][]{{5,2,4,1,3}}),new int[][]{{1,2,3,4,5}});
        assertArrayEquals(new Array19().sortSpiralMatrix(3,1,new int[][]{{5},{6},{14}}),new int[][]{{5},{6},{14}});

...
public class Array17Test {
    ...
    public void Test_setSpiralArray(){
        ...
        assertArrayEquals(new Array17().setSpiralArray(2),new int[][]{{1,2},{4,3}});
        assertArrayEquals(new Array17().setSpiralArray(3),new int[][]{{1,2,3},{8,9,4},{7,6,5}});
        assertArrayEquals(new Array17().setSpiralArray(4),new int[][]{{1,2,3,4},{12,13,14,5},{11,16,15,6},{10,9,8,7}});
    }
}
